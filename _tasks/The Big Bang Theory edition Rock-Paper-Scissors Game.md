...
#### Overview
- [English Description](../../dataset/The Big Bang Theory edition Rock-Paper-Scissors Game/task_c.pdf)
- [Chinese Description](../../dataset/The Big Bang Theory edition Rock-Paper-Scissors Game/task_e.pdf)
- [MiniZinc Specification](../../dataset/The Big Bang Theory edition Rock-Paper-Scissors Game/task_mzn.txt)

#### Problem Description
We provide the natural language description of the task in 3 formats (.pdf,.docx,.txt) and 2 languages (Chinese, English), the formal specification of MiniZinc description, which can be obtained by clicking the link under the title to download the whole task
#### Test
##### Input:
